                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                id="name" name="name" value="<?php echo e(old('name')); ?>" required autocomplete="name" autofocus
                                type="text"

                                class="form-control fontAwesome input-form  <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                id="phone" name="phone" value="<?php echo e(old('phone')); ?>" required autocomplete="phone" autofocus
                                type="text"

                                class="form-control fontAwesome input-form  <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4 password-container" style="position: relative">
                            ...
                            <input
                                ...
                                class="form-control fontAwesome input-form <?php $__errorArgs = ['password_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php /**PATH /home/pc-1/insurecow/resources/views/auth/register.blade.php ENDPATH**/ ?>