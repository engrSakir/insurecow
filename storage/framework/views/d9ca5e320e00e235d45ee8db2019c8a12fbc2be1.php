...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/fdash.css')); ?>">
    <style>
        .active {
            background: #ffffff;
        }
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion font-weight-bold" id="accordionSidebar" style="background: linear-gradient(rgba(199, 248, 201, 1),rgba(221, 237, 199, 1));">
        ...
        <a href="<?php echo e(route('fdashboard.index')); ?>" class="sidebar-brand d-flex align-items-center justify-content-center">
        ...
        <!-- Nav Item - Dashboard -->
        <li class="nav-item border-bottom border-dark <?php echo e((request()->is('fdashboard/home')) ? 'active' : ''); ?> mt-5 pt-2 pb-2">
            <a class="nav-link text-dark text-dark" href="<?php echo e(route('fdashboard.index')); ?>">
        ...
        <li class="nav-item border-bottom border-dark text-dark <?php echo e((request()->is('fdashboard/reg')) ? 'active' : ''); ?> pt-2 pb-2">
            <a class="nav-link text-dark" href="#">
                <i class="fas fa-fw  fa-cow text-dark"></i>
                <span>Cattle</span></a>
        </li>

        <li class="nav-item border-bottom border-dark text-dark <?php echo e((request()->is('fdashboard/company_request')) ? 'active' : ''); ?> pt-2 pb-2">
        ...
        <!-- Nav Item - History -->
        <li class="nav-item border-bottom border-dark text-dark <?php echo e((request()->is('fdashboard/calender')) ? 'active' : ''); ?> pt-2 pb-2">
            <a href="<?php echo e(route('fdashboard.calender')); ?>" class="nav-link text-dark">
                <i class="fas fa-fw fa-calendar text-dark"></i>
                <span>Calendar</span></a>
        </li>
        <li class="nav-item border-bottom border-dark text-dark <?php echo e((request()->is('fdashboard/history')) ? 'active' : ''); ?> pt-2 pb-2">
            <a href="#" class="nav-link text-dark">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <!-- Topbar -->
        <?php echo $__env->make('inc.fd_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- End of Topbar -->

        <?php echo $__env->yieldContent('content'); ?>

        <!-- Footer -->
        <?php echo $__env->make('inc.fd_footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- End of Footer -->
    </div>
...
<?php /**PATH /home/pc-1/insurecow/resources/views/layouts/fd.blade.php ENDPATH**/ ?>