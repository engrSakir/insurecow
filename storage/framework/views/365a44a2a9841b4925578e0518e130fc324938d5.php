<?php $__env->startSection('content'); ?>
           ...
           <div  style="display: flex; justify-content:right ; padding:20px;">
                 ...
                 <a href="<?php echo e(route('company.quotation_view')); ?>" class="d-none d-sm-inline-block btn btn-sm text-white shadow-sm" style="background-color: #086343"><i
                   ...
                   <div style="padding: 20px">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1 contents" rows="3"
                                  name="contents"
                                  v-model="contents"
                                  value="<?php echo e(old('contents')); ?>" requried></textarea>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="signature" class="form-control" value="<?php echo e(old('signature')); ?>"
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        var app = new Vue({
            ...
            mounted() {
                axios.get("<?php echo e(route('get_quotation_data')); ?>").then(el => {
            ...
            methods: {
                ...
                submitData(e) {
                    ...
                    axios.post("<?php echo e(route('quotation.update',$quotation->id)); ?>", formData).then(el => {
                        console.log(el);
                        location.reload();
                    });
                },
...
<?php echo $__env->make('layouts.company', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pc-1/insurecow/resources/views/company/edit_quotation.blade.php ENDPATH**/ ?>