        ...
        var app = new Vue({
            ...
            methods: {
                ...
                submitData(e) {
                    ...
                    axios.post("<?php echo e(route('quotation.store')); ?>", formData).then(el => {
                        console.log(el);
                        location.reload();
                    });
                },
...
<?php echo $__env->make('layouts.company', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pc-1/insurecow/resources/views/company/quotation.blade.php ENDPATH**/ ?>