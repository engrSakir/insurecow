...
<div class="container">
    <div class="row">
        <div class="col-md-4 mt-5">
            <a href="<?php echo e(route('farmer.index')); ?>" class="float-start mb-3 p-3 text-dark" style="background: linear-gradient(268.09deg, #C5EAD5 24.79%, #FFFFFF 99.54%);border-radius: 20px;"><i class="fas fa-long-arrow-alt-left"></i> Back</a>
...
<?php echo $__env->make('layouts.farmer_onboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pc-1/insurecow/resources/views/farmer/onboard/insurance_details.blade.php ENDPATH**/ ?>