                   ...
                   <div class="">
                       ...
                       <p class="flex items-center justify-center md:justify-start mb-4">
                           <a href="#!" class="text-gray-600">
                               {{ GoogleTranslate::trans('Home', app()->getLocale()) }}</a>
                       </p>
                       <p class="flex items-center justify-center md:justify-start mb-4">
                           <a href="#!"
                               class="text-gray-600">{{ GoogleTranslate::trans('Our Services', app()->getLocale()) }}</a>
                       </p>
                       <p class="flex items-center justify-center md:justify-start mb-4">
                           <a href="#!"
                               class="text-gray-600">{{ GoogleTranslate::trans('About Us', app()->getLocale()) }}</a>
                       </p>
                       <p class="flex items-center justify-center md:justify-start mb-4">
                           <a href="#!"
                               class="text-gray-600">{{ GoogleTranslate::trans('Blog', app()->getLocale()) }}</a>
                       </p>
                   </div>
                   <div class="">
                       <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
                       ...
                       <p class="flex items-center justify-center md:justify-start mb-4">
                           <a href="#!" class="text-gray-600">
                               {{ GoogleTranslate::trans('Bangladesh', app()->getLocale()) }}</a>
                       </p>
                       <p class="flex items-center justify-center md:justify-start mb-4">
                           <a href="#!" class="text-gray-600">
                               {{ GoogleTranslate::trans('India', app()->getLocale()) }}</a>
                       </p>
                       <p class="flex items-center justify-center md:justify-start mb-4">
                           <a href="#!" class="text-gray-600">
                               {{ GoogleTranslate::trans('Australia', app()->getLocale()) }}</a>
                       </p>
                       <p class="flex items-center justify-center md:justify-start mb-4">
                           <a href="#!" class="text-gray-600">
                               {{ GoogleTranslate::trans('Newzealand', app()->getLocale()) }}</a>
                       </p>
                   </div>
                   <div class="">
                       <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
