...
<body>
    <section class="first-section">
        <div>
            ...
            <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #d7eccb">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav m-auto">
                        <li class="nav-item active">
                            <a class="nav-link nav-font" href="{{ url('/') }}">Home <span
                    ...
                    @if (auth()->user())
                        <li class="nav-item dropdown navbar-brand">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                ...
                                @endphp
                                @if ($profile)
                                    <img src="{{ asset('/storage/' . $profile->image) }}" class="img-fluid bs-img"
                                        width="20px">
                                @else
                                    <img src="{{ asset('/images/profile.png') }}" class="img-fluid bs-img"
                                        width="20px">
                                @endif
                    ...
                    @else
                        ...
                        <a href="{{ route('register') }}" class="btn"
                            style="background-color: #0f6848;color: #FFFFFF">Sign Up</a>
                    @endif
                </div>
            </nav>
                    ...
                    <div class="card login-card p-5 h-100 shadow-none">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="col-12 mb-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value=""
                                            ...
                                            {{ old('remember') ? 'checked' : '' }} id="invalidCheck2" />
                                        <div class="d-flex justify-content-between mb-5">
                                            <label class="form-footer-text" id="invalidCheck2">Keep me signed
                                                in</label>
                                            @php
                                                $token = uniqid();
                                            @endphp
                                            <a href="{{ route('password.reset', $token) }}"
                                                class="form-footer-text"><label>Forgot password?</label></a>
                                ...
                                <!--Log In Button-->
                                <button type="submit" class=" mb-4 form-control"
                                    style="background-color: #1D5C2E; color: white">Log In</button>
                                <button type="#" class=" mb-4 form-control"
                                    style="background-color: #ffff; color: #000000;font-weight: 600"><i
                                        class="fab fa-google fa-x"></i> Continue with Google</button>


                            </form>
                            Don’t have an account? <a href="{{ route('register') }}"
                                style="text-decoration: none; color: #1D5C2E">Sign Up</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="h-100">
                        <div class="card-body">
                            <img src="{{ asset('/images/ImagesLoginpage.png') }}" class="img-fluid"
                                alt="Cow" />
                        </div>
                    </div>
                </div>
    ...
    <section>
        ...
        <footer style="background: rgba(200, 237, 211, 0.8);">
