...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion font-weight-bold" id="accordionSidebar"
            style="background: linear-gradient(rgba(199, 248, 201, 1),rgba(221, 237, 199, 1));">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
                ...
                @else
                    <div class="sidebar-brand-icon mt-5">
                        <img src="{{ asset('storage/' .\App\Company::where('user_id', auth()->user()->id)->orderBy('id', 'desc')->first()->image) }}"
                            class="img-fluid" width="100px" alt="nothing">
                    </div>
                @endif
            ...
            <!-- Nav Item - Dashboard -->
            <li
                class="nav-item border-bottom border-dark {{ request()->is('company/home') ? 'active' : '' }} mt-5 pt-2 pb-2">
            ...
            @if (auth()->user()->company()->count() == 0)
                <!-- Nav Item - Profile -->
                <li
                    class="nav-item border-bottom border-dark {{ request()->is('company/profile') ? 'active' : '' }} pt-2 pb-2">
            ...
            @else
                ...
                <li
                    class="nav-item border-bottom border-dark text-dark {{ request()->is('company/profile/edit') ? 'active' : '' }} pt-2 pb-2">
            ...
            <li
                class="nav-item border-bottom border-dark text-dark {{ request()->is('company/reg') ? 'active' : '' }} pt-2 pb-2">
            ...
            <!-- Nav Item - History -->
            <li
                class="nav-item border-bottom border-dark text-dark {{ request()->is('company/history') ? 'active' : '' }} pt-2 pb-2">
            ...
            @if (auth()->user()->policy()->count() == 0)
                <!-- Nav Item - Profile -->
                <li
                    class="nav-item border-bottom border-dark {{ request()->is('company/policy') ? 'active' : '' }} pt-2 pb-2">
            ...
            @else
                <!-- Nav Item - Profile Edit -->
                <li
                    class="nav-item border-bottom border-dark text-dark {{ request()->is('company/policy/edit') ? 'active' : '' }} pt-2 pb-2">
            ...
            @if (auth()->user()->quotation()->count() == 0)
                <!-- Nav Item - Profile -->
                <li
                    class="nav-item border-bottom border-dark {{ request()->is('company/quotation') ? 'active' : '' }} pt-2 pb-2">
            ...
            @else
                <!-- Nav Item - Profile Edit -->
                <li
                    class="nav-item border-bottom border-dark text-dark {{ request()->is('company/quotation/edit') ? 'active' : '' }} pt-2 pb-2">
            ...
            <li
                class="nav-item border-bottom border-dark text-dark {{ request()->is('company/') ? 'active' : '' }} pt-2 pb-2">
            ...
            <li
                class="nav-item border-bottom border-dark text-dark {{ request()->is('company/pending_quotation') ? 'active' : '' }} pt-2 pb-2">
                <a href="{{ route('company.pending_quotation') }}" class="nav-link text-dark">
                    <i class="fas fa-fw fa-user-clock text-dark"></i>
                    <span>Insurance Request</span></a>
            </li>

            <li
                class="nav-item border-bottom border-dark text-dark {{ request()->is('company/package') ? 'active' : '' }} pt-2 pb-2">
                <a href="{{ route('package.index') }}" class="nav-link text-dark">
                    <i class="fas fa-fw fa-box-open text-dark"></i>
                    <span> Create Packages</span></a>
            </li>
            <li
                class="nav-item border-bottom border-dark text-dark {{ request()->is('company/view_package') ? 'active' : '' }} pt-2 pb-2">
