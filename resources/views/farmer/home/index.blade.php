        ...
        <div class="d-lg-flex d-md-flex justify-content-center">
            ...
            <div class="col-lg-4 col-md-6 mb-4 me-lg-5 me-md-4">
                <div class="card card-style">
                    ...
                    <div class="text-center p-4">
                        <a href="../view_cow_lists/view_cow_lists.html" class="btn card-button" style="background-color: #0f6848" >Continue</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card card-style">
                    ...
                    <div class="text-center p-4">
                        <a href="../agent_details/agent_details.html" class="btn card-button" style="background-color: #0f6848">Continue</a>
                    </div>
                </div>
            </div>
        </div>
