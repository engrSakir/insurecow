        ...
        <div class="d-lg-flex d-md-flex justify-content-center">
            ...
            <div class="col-lg-7">
                <div>
                    ...
                    <p align="center">{{ GoogleTranslate::trans('Here is some option for you.',app()->getLocale())}}</p>
                    @if(auth()->user()->farmer_profile == null)
                        <center><a href="{{ route('farmerprofiles.index') }}" class="btn w-50 text-white text-center mt-5 mb-5" style="background-color: #0f6848"> {{GoogleTranslate::trans('Set your profile',app()->getLocale())}}</a></center>
                    @else
