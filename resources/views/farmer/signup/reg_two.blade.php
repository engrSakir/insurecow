                ...
                <div class="row px-4">
                    <div class="col-md-6 mb-4">
                        <div class="form-outline">
                            ...
                            <div class="col">
                                <input type="text" id="inputDivision" class="form-control input-style"/>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="form-outline">
                            ...
                            <div class="col">
                                <input type="text" id="inputDistrict" class="form-control input-style"/>
                ...
                <div class="row px-4">
                    <div class="col-md-6 mb-4">
                        <div class="form-outline">
                            ...
                            <div class="col">
                                <input type="text" id="inputThana" class="form-control input-style"/>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="form-outline">
                            ...
                            <div class="col">
                                ...
                                <input type="text" id="inputPost" class="form-control input-style"/>
                ...
                <div class="row px-4">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="form-outline">
                            ...
                            <div class="col">
                                <input type="text" id="inputColor" class="form-control input-style"/>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="form-outline">
                            ...
                            <div class="col">
                                ...
                                <input type="text" id="inputBreed" class="form-control input-style"/>
                ...
                <div class="row px-4">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="form-outline">
                            ...
                            <div class="col">
                                ...
                                <input type="text" id="agentName" class="form-control input-style"/>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="form-outline">
                            ...
                            <input type="text" id="agentEmployeeId" class="form-control input-style"/>
                        </div>
                    </div>
...
<script>
    window.axios.get('https://forkify-api.herokuapp.com/api/search?q=pizza').then(el => {
        console.log(el);
    });
</script>
